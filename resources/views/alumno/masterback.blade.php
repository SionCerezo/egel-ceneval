...
<head>
    ...
    .egel-convocatoria-title {
        ...
        /* padding: 0; */
        color: #ea4d06 !important;
        /* word-wrap: break-word;
        position: relative; */
    }

    .egel-convocatoria-descrip {
        margin: 30px 0px 0px;
    }
    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            <div class="blog-item post-item">
                <div class="egel-card-convocatoria">
                    <div class="egel-convocatoria">
                        <div class="egel-conv-periodo">
                            <span class="egel-conv-periodo-name">Primavera</span>
                            <span class="egel-conv-periodo-year">2020</span>
                        </div>

                        <h6 class="egel-convocatoria-title">{{ $convocatoria->title }}</h6>

                        <div class="meta-info-blog">
                            <span><i class="fa fa-calendar"></i>
                                <a href="https://www.free-css.com/free-css-templates">{{ localDate($convocatoria->start_date) }} - {{ localDate($convocatoria->end_date) }}</a>
                            </span>
                        </div>
                        <hr>
                        <p class="egel-convocatoria-descrip">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt</p>
                ...
                <div class="post-content">
                    ...
                    <div class="meta-info-blog">
                        ...
                        <span><i class="fa fa-calendar"></i>
                            <a href="https://www.free-css.com/free-css-templates">{{ localDate($convocatoria->end_date) }} - {{ localDate($convocatoria->end_date) }}</a>
                        </span>
                        <span><i class="fa fa-lock-open"></i>
                            <a href="https://www.free-css.com/free-css-templates">Estatus: {{ $convocatoria->status->valor }}</a>
                        </span>
                        <span><i class="fa fa-comments"></i> <a href="https://www.free-css.com/free-css-templates">12 Comments</a></span>
                    </div>
                    <div class="blog-desc">
                        {{ localDate($convocatoria->end_date) }}
                        {!! $convocatoria->descripcion !!}
                    </div>
                </div>
                @else
                    <div>No hay convocatorias activas por el momento</div>
                @endisset
            </div>
            <!-- ============================================================== -->
            <!-- End Container fluid  -->
