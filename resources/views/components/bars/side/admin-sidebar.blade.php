<ul id="sidebarnav">
    ...
    <li class="sidebar-item">
        <a class="sidebar-link" href="{{ route('postulacion.index') }}" aria-expanded="false">
    ...
    {{-- Convocatoria activa --}}
    <li class="sidebar-item">
        <a class="sidebar-link" href="{{ route('admin.convocatoria.active') }}" aria-expanded="false">
            <i data-feather="file-text" class="feather-icon"></i>
            <span class="hide-menu">Convocatoria activa</span>
        </a>
    </li>
