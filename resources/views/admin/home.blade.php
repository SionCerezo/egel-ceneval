...
<ul id="sidebarnav">
    <li class="sidebar-item">
        <a class="sidebar-link sidebar-link" href="{{ route(Route::currentRouteName()) }}" aria-expanded="false">
    ...
    <li class="list-divider"></li>
    <li class="nav-small-cap"><span class="hide-menu">Convovatorias</span></li>
    <li class="sidebar-item"> <a class="sidebar-link" href="{{ route('admin.convocatorias') }}"
            aria-expanded="false"><i data-feather="file-text" class="feather-icon"></i><span
                class="hide-menu">Convocatorias
            </span></a>
    </li>
    <li class="sidebar-item">
        <a class="sidebar-link" href="{{ route('admin.convocatoria.create') }}"
            aria-expanded="false"><i data-feather="file-text" class="feather-icon">
            </i><span class="hide-menu">Crear convocatoria</span>
        </a>
    </li>
